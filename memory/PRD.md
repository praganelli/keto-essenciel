...
## Module 6 — chapitre 4 refait : « Le sommeil : votre meilleur allié invisible » (fork, juin 2026)
...
## Module 6 — chapitres 5→10 + Quiz final (fork, juin 2026)
- Ch.5 « Les étirements » REMPLACÉ par « Le stress : comprendre son impact et apprendre à le gérer » (badge « Je gère mon stress »). Ch.6-10 AJOUTÉS (titres/descriptifs utilisateur, contenu rédigé par l'agent, structure homogène 5 pages/chapitre + mission + quiz 5 q) : Ch.6 Hydratation (« Je pense à bien m'hydrater »), Ch.7 Suivre ses progrès sans devenir obsédé (« Je suis mes progrès avec sérénité »), Ch.8 Rester motivé/habitudes durables (« Je construis des habitudes durables »), Ch.9 Idées reçues diabète/sport/alimentation (« Je m'informe avec discernement »), Ch.10 Construire un mode de vie durable (bilan + plan d'action 3 priorités).
- QUIZ FINAL Module 6 : fq 20 questions (couvre les 10 chapitres), bd:"🏃 Mode de vie équilibré", sk: 7 compétences. Module 6 = 10 chapitres. Script /app/apply_m6_ch5_10.py (python replace).
- Images : SUBJECTS (5,4)→stress + (5,5)-(5,9) ajoutés, EXTRAS m5c4b/c/d … m5c9b/c/d (18) ajoutés dans gen_parcours_img.py. Ancien m5c4.jpg (étirements) SUPPRIMÉ. ⚠️ Clé OpenAI toujours en Billing hard limit → 35 images en attente : m5c0, m5c1b-d, m5c2b-d, m5c3, m5c3b-d, m5c4-m5c9 (defaults), m5c4b-d…m5c9b-d. Relance : cd /app/backend && python3 gen_parcours_img.py --only m5c0,m5c1b,m5c1c,m5c1d,m5c2b,m5c2c,m5c2d,m5c3,m5c3b,m5c3c,m5c3d,m5c4,m5c4b,m5c4c,m5c4d,m5c5,m5c5b,m5c5c,m5c5d,m5c6,m5c6b,m5c6c,m5c6d,m5c7,m5c7b,m5c7c,m5c7d,m5c8,m5c8b,m5c8c,m5c8d,m5c9,m5c9b,m5c9c,m5c9d
- Testé E2E (guest+diabete, 390px) : 10 chips, tous nouveaux titres présents, ch5 & ch10 = 5 pages, mission+badge ch10 OK, carte Quiz final visible à 100%, quiz final ouvert = 20 questions (Q1 activité physique OK), images m5c9b référencées. fix_tail + node --check OK, sync keto_app.html.

## Module 7 — refonte complète « Comprendre et réussir sa perte de poids durable » (fork, juin 2026)
- Module 7 (index 6, « Perte de poids » 5 chapitres) ENTIÈREMENT REFAIT : 10 chapitres × 5 pages + mission + quiz 5 q + badge chacun. Titres/objectifs fournis par l'utilisateur, contenu rédigé par l'agent : Ch.1 Pourquoi grossit-on (« Je comprends mon corps »), Ch.2 Graisse viscérale (« Je cible la bonne graisse »), Ch.3 Métabolisme (« Je connais mon métabolisme »), Ch.4 Plateaux (« Je dépasse les plateaux »), Ch.5 Hormones insuline/leptine/ghréline/cortisol (« Je comprends mes hormones »), Ch.6 Écarts sans culpabiliser (« Je gère les écarts sans culpabilité »), Ch.7 Freins cachés (« Je lève mes freins cachés »), Ch.8 Effet yo-yo (« J'évite l'effet yo-yo »), Ch.9 Vrais indicateurs (« Je mesure ma vraie réussite »), Ch.10 Transformation durable. QUIZ FINAL 20 q, bd:"⚖️ Maîtrise de la perte de poids durable", sk: 8 compétences. Script /app/apply_m7.py (remplacement par bornes START/END).
- Images : existantes réaffectées (m6c2↔m6c3 swap car ch3=métabolisme/ch4=plateaux ; m6c4→m6c5 car écarts=ch6). SUBJECTS (6,4)/(6,6)-(6,9) + 30 EXTRAS m6c0b…m6c9d ajoutés à gen_parcours_img.py. ⚠️ Billing OpenAI toujours bloqué → total ~70 images en attente (m5c* 35 + m6c* 35). Relance générale : cd /app/backend && python3 gen_parcours_img.py (idempotent, saute les existantes).
- Testé E2E (guest+diabete, 390px) : 10 chips, 10 titres OK, ch5 img m6c4b référencée, ch10 mission+badge, quiz final ouvert (Q1 « On grossit principalement parce que » + « sur 20 »), screenshot ch1 avec image m6c0 affichée. fix_tail + node --check OK, sync keto_app.html.

## Modules 9 & 10 — refonte complète (fork, juin 2026)
- Module 9 (index 8) « Stress, sommeil et équilibre glycémique » 😌 et Module 10 (index 9) « Les compléments alimentaires : lesquels, pourquoi, dans quelles situations ? » 💊 ENTIÈREMENT REFAITS via /app/apply_m9.py et /app/apply_m10.py : 10 chapitres × 5 pages + mission + quiz 5 q + badge chacun, QUIZ FINAL 20 q (seuil 80 %). Badges modules : 😌 « Maître de mon équilibre » / 💊 « Utilisation raisonnée des compléments alimentaires ». Parcours = 89 chapitres au total.
- Images réaffectées dans pc_img (nouveaux index) : M8 → m7c1(lipides)→m7c4, m7c3(inflammation)→m7c5, m7c4(foie/reins)→m7c6, copie m0c4→m7c1 (HbA1c) ; M9 → m8c1(respiration)→m8c3, m8c2(relaxation)→m8c5, m8c3(cohérence)→m8c4, m8c4(soir)→m8c7 ; M10 → m9c3(médecin)→m9c0, m9c0(magnésium)→m9c1, m9c1(vitD)→m9c3, m9c2(berbérine)→m9c5.
- gen_parcours_img.py : SUBJECTS M8/M9/M10 complétés à 10 chapitres chacun + 90 EXTRAS ajoutés (m7c0b…m7c9d, m8c0b…m8c9d, m9c0b…m9c9d). Total : 84 subjects, 191 extras.
- ⚠️ BLOCAGE PERSISTANT : clé OpenAI toujours « Billing hard limit has been reached » (retesté cette session) → 175 images en attente au total (backlog m5c*/m6c* + nouveaux m7c*/m8c*/m9c* defaults et extras). Relance générale quand facturation OK : cd /app/backend && python3 gen_parcours_img.py (idempotent). Les images manquantes sont masquées via onerror dans l'app (dégradation propre).
- Testé E2E (guest + dietMode diabete + déblocage progression via profile.diabParcours.done, 390px) : liste 12 modules OK (M8/M9/M10 = 10 chapitres), M9 ch1 « Pourquoi le stress influence votre glycémie ? » (image m8c0 affichée), M10 ch1 « utiles ou inutiles ? » (image m9c0), liste chapitres M10 complète + carte Quiz final 20 questions. node --check syntaxe OK (11 scripts). Sync backend/keto_app.html + restart.
- Verrouillage confirmé : modules 9/10 verrouillés tant que le module précédent n'est pas à 100 % (toast 🔒).

## Module BONUS « Le guide de survie Keto-Essenciel » + Certificat final (fork, juin 2026)
- Module 13 (index 12, flag bonus:true) AJOUTÉ après « Le suivi » via /app/apply_bonus.py : 12 chapitres × 5 pages + mission + quiz 5 q + badge chacun (Restaurant, Vacances, Invitations, Alcool, Jeûne intermittent, Édulcorants, Sport, Voyages, Courses, Fast-food, Fêtes de famille, Noël/Nouvel An). QUIZ FINAL 20 q (seuil 80 %), bd:"🌟 Expert Keto-Essenciel", sk: 10 compétences. Parcours = 101 chapitres au total.
- Label « Module bonus » : helper pcModLabel(mi) ajouté + remplacé dans les 5 rendus (home hero, liste modules, page module, page chapitre, quiz). Sous-titre home : « 12 modules + 1 module bonus ».
- CERTIFICAT FINAL 🎓 : carte « Parcours Keto-Essenciel terminé » (data-testid pc-certificat) affichée sur la home du Parcours quand done===tot (101/101) — liste des 8 ✅ compétences + mention « 🌟 Vous êtes officiellement Expert Keto-Essenciel ».
- Images : SUBJECTS (12,0)-(12,11) + 36 EXTRAS m12c0b…m12c11d ajoutés à gen_parcours_img.py (96 subjects, 227 extras au total). ⚠️ Billing OpenAI toujours bloqué → images bonus en attente (masquées via onerror). Relance : cd /app/backend && python3 gen_parcours_img.py
- Testé E2E (guest+diabete, 390px) : module bonus hero « MODULE BONUS », 12 chapitres listés, ch1 restaurant ouvert, quiz final « Question 1 sur 20 », certificat affiché à 101/101 (100 %). node --check OK, sync backend/keto_app.html + restart.

## Module 0 « Bienvenue dans Keto-Essenciel » 🌿 (fork, juin 2026)
- Module 0 (index 0, flags intro:true + ip:"mw") INSÉRÉ EN TÊTE du Parcours via /app/apply_m0.py : 5 chapitres × 5 pages + mission + quiz 5 q + badge — Ch.1 Bienvenue (contenu utilisateur intégral, Patrice Raganelli naturopathe), Ch.2 Comment fonctionne l'application, Ch.3 Réaliser votre premier bilan, Ch.4 Définir vos objectifs personnalisés, Ch.5 Construire votre parcours et vos premières habitudes (ch.2-5 rédigés par l'agent, option 2 validée). QUIZ FINAL 10 q (80 %), bd:"🌿 Prêt pour le parcours", sk: 6 compétences. Parcours = 14 modules / 106 chapitres.
- DÉCOUPLAGE IMAGES/INDEX : champ ip:"mX" ajouté sur les 14 modules (anciens modules gardent m0…m12, Module 0 = mw) ; pcRenderChapter utilise (m.ip||'m'+V.m) → aucune image existante à renommer.
- MIGRATION progression : pcState() décale automatiquement les clés done (mi-ci → (mi+1)-ci) et final (mi → mi+1) des profils existants (flag migM0). Testé : {'0-0','0-1'} → {'1-0','1-1'} ✓.
- FIX déverrouillage : pcModUnlocked accepte désormais un module avec progression existante (pcModDoneCount>0) → les utilisateurs migrés en cours de module ne sont PAS bloqués par le Module 0 à 0 %. Testé : module 4 en cours (50 %) ouvrable alors que Module 0 = 0 % ✓.
...
## Refonte présentation accueil (mockup) + FAB « + » Accès rapides (fork, juillet 2026)
- Script /app/apply_home.py (12 remplacements). Module <style id="kpHomeStyles"> + <script id="kpHomeModule"> inséré AVANT kpParcoursModule.
- LOGIN : « Bienvenue ! » réduit (23px base / clamp mobile 18-22), logo présenté sur carte blanche arrondie distincte (fond #fff, radius 26, ombre).
- HEADER MOBILE (≤980px) : #kpHomeHeader = emblème logo rond (crop webp base64) + « Keto-Essenciel » + pastille statut GRATUITE/PREMIUM (#kpHomeStatus, sync via kpSyncHomeStatus depuis planStatusMobileTxt, clic → openPremiumModal) + cloche → openPrefs(). Ancien header (eyebrow, h1, brand-badge, kp-hero-date, logout) masqué sur mobile. PAS de menu hamburger (demande utilisateur).
- DASHBOARD Plan mobile (#kpDashHost, caché ≥981px) rendu par kpRenderDashboard() : « Bonjour {prénom} ! 👋 » + avocat webp (Nano Banana, fond transparent) ; carte « Résumé du jour » (4 stats calculées du menu du jour via addRecipeMacros/recipeAtSlot : glucides nets g, % lipides, kcal, % objectif score composite) ; « Objectif du jour » (cible glucides + anneau conic % budget) ; « Repas du jour » (carrousel horizontal scroll-snap : photo GCS KP_RECIPE_PHOTOS ou emoji, badge repas, g net + kcal, clic → openRecipe, points de pagination, « Voir tout › » → setDayView('day')). Hooks : wrap switchTab('plan') + generateMenu + boot 900ms.
...
## Plein écran mobile automatique + popup « Nouveautés v2.0 » (fork, juillet 2026)
- PLEIN ÉCRAN MOBILE : détection téléphone (userAgent Android/iPhone/iPad/Mobile) hors mode standalone → requestFullscreen(navigationUI:'hide') au 1er geste (touchend/click, one-shot, silencieux si refusé). iOS Safari ne supporte pas l'API → couvert par PWA standalone + viewport-fit=cover (déjà présent) + apple-mobile-web-app-status-bar-style passé de 'default' à 'black-translucent' (contenu sous la barre de statut en PWA).
- POPUP « Nouveautés v2.0 » (#kpWhatsNew, one-shot via localStorage kp_whatsnew_v2) : s'affiche 3s après entrée dans l'app (attend que authScreen ET kpWelcomeScreen soient masqués, retry 4s), logo v2 (src copié de .khh-logo-h), 4 nouveautés, CTA « Découvrir → » → kpWhatsNewClose() pose le flag. z-index 9430. Testé : affichage stylé, fermeture, flag=1, 0 erreur JS.
- ⚠️ LEÇON : NE PAS faire de search_replace PARALLÈLES sur le MÊME fichier (keto.html) — un patch CSS a été perdu (écrasé par l'écriture concurrente du patch JS, "Edit successful" trompeur). Toujours séquentiel sur keto.html.

## Accès rapides impression + réorganisation accueil + logo header (fork, juillet 2026)
- Feuille « Accès rapides » : +2 tuiles permanentes « 🖨️ Imprimer le menu » (exportPDF) et « 🧾 Imprimer les courses » (printShopping) — 5 tuiles au total.
...
## Refonte accueil « mockup dashboard » + fix fuite ingrédients exclus (fork, juillet 2026)
- ACCUEIL MOBILE (#kpDashHost, kpHomeModule ~28400) refondu selon mockup utilisateur, ordre : salutation (« Bonjour {prénom} 👋 » + « Votre santé avance, un repas à la fois. » + avocat) → kpWeekPulse → carte « Progression aujourd'hui » (kpd-prog : anneau %, « Objectif du jour » + statut en bonne voie/presque atteint/atteint/dépassé, barre, « Xg restants avant l'objectif », clic → vue Jour) → 4 tuiles stats (kpd-tiles : Glucides nets/Lipides/Calories/Objectif) → carte verte « ✨ PLANIFIER MA SEMAINE / Générer ma semaine » (kpd-gen, bouton blanc pill → generateMenu) → « Prochain repas » (kpd-meals, carrousel, pills kcal + g net, « Voir la recette → », le repas à venir selon l'heure (b<11h, l<15h, d ensuite) passe en 1er) → cartes modes alimentaires (kpd-modes, scroll horizontal : TOUS les DIET_MODES sauf vegan + Mode Musculation + Compléments (ou Formations si diabète) ; badge ✓ actif, 🔒 premium → openPremiumModal, végétarien → openVeggieSubmodeModal, sinon kpHomeSetMode→applyDietMode) → « Astuce du jour » (kpd-tip, rotation quotidienne KPD_TIPS, tap = suivante).
- .plan-gen-hero masqué sur mobile (remplacé par kpd-gen) ; sans menu généré : greet+gen+modes+tip seulement.
- Données RÉELLES (choix user 1a/2a/3a) : progression/tuiles calculées du menu du jour vs targets ; prochain repas lié au plan ; cartes modes ouvrent les vraies sections.
...
## Résumé nutritionnel + Hydratation + avatar + nav moderne (fork, juillet 2026)
- Popup « Menu du jour » : overrides #day-panel dans kpHomeModule (hero vert gradient, boutons ronds, tuiles/sections harmonisées — attention le thème « editorial » ligne ~5482 met .day-hero-bg opacity .10 !important, contourné via background sur .day-hero + opacity:0 sur bg).
- ACCUEIL — nouvelle carte « Résumé nutritionnel » (kpn-*) : anneau kcal restantes (kcalT − kcal des repas COCHÉS ✓), barre « Répartition kcal » segmentée (Lipides #e8a659 / Prot #8fae62 / Gluc #79bcd8), 3 lignes macros avec barres (consommé/objectif targets), footer Fibres (estimation vegG*0.03+carb*0.4) / Eau (hydratation) / Légumes (150g par accompagnement des repas cochés). Badge score 🏅 obj/100 + médaille (Or≥90/Argent≥75/Bronze≥60).
...
## AUTH LUX + NAV CAPSULE (fork, juin 2026)
- Écrans Connexion/Inscription refaits (blocs <style id="kpAuthLux"> + <script id="kpAuthLuxJS">) : hero dégradé F9F9F7→vert pâle avec goutte ambrée flottante (klxaFloat) + logo fade-in ; inscription = feuilles qui tombent (.klxa-leaf) + titre "Bienvenue chez Keto-Essenciel" ; carte .auth-card en frosted glass slide-up ; champs bordure 1px avocat + halo focus ; validation email temps réel (classes klxa-ok/klxa-err sur #regEmail) ; force mdp #klxaStrength (4 barres, data-s 0-4) ; Prénom/Nom en .klxa-namerow (wrap JS) ; transitions slide (klxa-in-left/right) via wrapper de authSwitchTab ; .kp-auth-editorial/.auth-tabs/.auth-logo masqués. Landing marketing INCHANGÉE.
- Hydratation premium : .kph-glass liquid-fill bleu pâle (::after hauteur animée + ::before vague klxaWave), barre .kph-bar ondulante (klxaBarFlow), classe 'goal' à 100% (patch kpHydroHTML) → pulsation dorée klxaGoalPulse.
- Nav basse "capsule liquid glass" (bloc <style id="kpNavLux">, media ≤1023px) : détachée (bottom 14px+safe-area, 18px latéral), radius 30px, verre rgba(255,255,255,.42)+blur(24) + bordure blanche fine + ombre diffuse ; pill spring .28s cubic-bezier(.34,1.56,.64,1) ; icônes spring au clic (knvIconPop) ; padding-bottom:118px sur les tabs. ⚠️ Sélecteur `.bottom-nav .bottom-nav-inner` requis (une règle legacy à ~l.23801 force border-radius:0 !important avec cette spécificité).
- ⚠️ CONNU (infra, PAS le code) : dans le navigateur de test headless, le canal WebChannel Firestore échoue par intermittence (code=unavailable, net::ERR_ABORTED) → le login Firebase réussit ("✅ Bienvenue") mais l'app attend le profil Firestore et l'écran d'auth ne se ferme pas. Survenu aussi chez le testing agent (iteration_15). Fonctionnait à 12:40, cassé à 12:47 sans changement JS. Si l'utilisateur le constate sur son appareil : envisager initializeFirestore(app,{experimentalAutoDetectLongPolling:true}).
- RAPPEL SYNC : cp /app/keto.html /app/backend/keto_app.html après chaque édition.

## HYDRATATION v2 + FIX CORRUPTION (juin 2026)
- kpHydroSet patché : mise à jour EN PLACE du DOM (classes .full, barre, litres, footer) pour laisser jouer la transition CSS de remplissage 600ms (cubic-bezier(.34,1.3,.45,1) = léger débordement puis stabilisation) ; re-render silencieux différé 1,4s ; micro-son d'eau WebAudio kpHydroSound() (désactivable via localStorage kp_hydro_sound='off').
- CSS verres : cristal frosted (blur 8px, bordure blanche .78, reflet vertical ::before), eau ::after bleu pâle translucide avec surface ondulante intégrée (couche radial-gradient scallops animée klxaWaterShift).
- 🐛 FIX : fichier corrompu en fin — le JSON kpRecipeDetailsData avait un fragment dupliqué APRÈS `</script></body></html>` + une 2e fermeture → texte brut affiché en bas de toutes les pages. Réparé par troncature à la 1ère fermeture (JSON 474 recettes validé, balises script équilibrées). ⚠️ Vérifier l'équilibre `<script>/</script>` après toute grosse édition python sur ce fichier.

## FIX ESPACE HAUT + VERROU SWIPE AUTH (juin 2026)
